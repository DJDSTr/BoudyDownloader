...
## Installation
To use the YouTube Video Downloader, download the latest release from the [Releases](https://github.com/DJDSTr/BoudyDownloader/releases/Latest) or our official page [here](https://boudy-ytdownloader.netlify.app/) . Once downloaded, run the installer and follow the on-screen instructions.
